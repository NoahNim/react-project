...
function Navigation({ isLoaded }) {
    ...
    return (
        <>
            <button onClick={handleNav} className="button" hidden={navOpen}><img src="https://icon-library.com/images/hamburger-menu-icon-transparent/hamburger-menu-icon-transparent-4.jpg" height="10" weidth="10"></img></button>
            {navOpen &&
                <nav className="nav">
